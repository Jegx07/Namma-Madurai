      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center gap-3 border-b border-white/10 px-4 bg-black/20">
            <div className="flex h-10 w-10 items-center justify-center rounded-full overflow-hidden bg-white/10 border border-primary/30 shadow-[0_0_10px_rgba(74,222,128,0.2)]">
      ...
      <div className="flex flex-1 flex-col bg-transparent relative">
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-white/10 bg-black/40 px-4 lg:hidden backdrop-blur-md">
          ...
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-full overflow-hidden bg-white/10 border border-primary/30">
              <img src="/2.png" alt="Logo" className="h-full w-full object-contain p-0.5" />
            </div>
